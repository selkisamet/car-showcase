                                ...
                                <Dialog.Panel className="relative w-full max-w-lg max-h-[100vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5">
                                    ...
                                    <div className="flex-1 flex flex-col gap-3">
                                        <div className="relative w-full h-40 bg-pattern bg-cover bg-center rounded-lg">
                                            <Image src={generateCarImageUrl(car)} className="object-contain" fill priority alt="car model" />
                                        </div>

                                        <div className="flex gap-3">
                                            <div className="flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg">
                                                <Image src={generateCarImageUrl(car, "29")} className="object-contain" fill priority alt="car model" />
                                            </div>

                                            <div className="flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg">
                                                <Image src={generateCarImageUrl(car, "33")} className="object-contain" fill priority alt="car model" />
                                            </div>

                                            <div className="flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg">
                                                <Image src={generateCarImageUrl(car, "13")} className="object-contain" fill priority alt="car model" />
                                            </div>
                                        </div>
                                    </div>
